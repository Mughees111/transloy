...
class users extends ADMIN_Controller {
    ...
    public function add (){
        ...
        $this->form_validation->set_rules('amount_1','5 mins price','trim|required');
        $this->form_validation->set_rules('amount_2','15 mins price','trim|required');
        $this->form_validation->set_rules('amount_3','30 mins price','trim|required');
        $this->form_validation->set_rules('amount_4','60 mins price','trim|required');
        ...
        if($this->form_validation->run() === false){
            ...
            $dbData['amount_1 '] = $this->input->post('amount_1');
            $dbData['amount_2 '] = $this->input->post('amount_2');
            $dbData['amount_3 '] = $this->input->post('amount_3');
            $dbData['amount_4 '] = $this->input->post('amount_4');
    ...
    public function delete($id){
        ...
        $this->db->where('user_id',$id);
        $this->db->delete('party_likes');

        $this->db->where('user_id',$id);
        $this->db->delete('party_times');
