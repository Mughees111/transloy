...
class Invoice_templates extends ADMIN_Controller {
    ...
    public function view($id=0,$order=0)
    {
            ...
            if($id!=0)
                $where_invoice["id"]=$id;
            $this->data['invoice_template'] = $this->db->where($where_invoice)->get('invoice_templates')->result_object()[0];
            ...
            foreach($products as $key=>$product)
            {
                ...
                $sub_total = ($product->price - $discount ) * $products_order[$key]->qty;
