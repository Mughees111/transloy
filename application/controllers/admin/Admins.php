	...
	public function add (){
	    ...
	    if($this->form_validation->run() === false){
            ...
            $this->email
                ...
                ->message("Admin just created your account as an admin on ".settings()->site_title.", your login details are:<br> Your username is: <br> <span style='background:#f5f5f5;padding:5px;'>".$dbData['email']."</span> <br> Your password is: <br> <span style='background:#f5f5f5;padding:5px;'>".$this->input->post('password')."</span> <br> <b>You can login on the web at <a href='".base_url()."/admin'>Admin</a></b>")
                ->set_mailtype('html');
