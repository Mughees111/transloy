            ...
            <div class="card">
                ...
                <div class="card-body lang_bodieslisting" >
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <textarea class=" form-control form-control-line" name="<?php echo $input; ?>" ><?php if(set_value($input) != ''){ echo set_value($input);}?></textarea>
                            <div class="text-danger"><?php echo form_error($input);?></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="text" name="<?php echo $input; ?>" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="Latitude" value="<?php if(set_value($input) != ''){ echo set_value($input);}else echo $prev->lat;?>" >
                            <div class="text-danger"><?php echo form_error($input);?></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            ...
                            value="<?php if(set_value($input) != ''){ echo set_value($input);}else echo $prev->lng;?>" 
                            >
                            <div class="text-danger"><?php echo form_error($input);?></div>
                        </div>
                    </div>
                    ...
                    <input class="form-control" name="pickup_title" id="pac-input"  type="text"
                            placeholder="Pickup">
                    <input type="hidden" name="pickup_lat" value="" id="pickup_lat">
                    <input type="hidden" name="pickup_lng" value="" id="pickup_lng">
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <select class="custom-select form-control required" name="<?php echo $input; ?>">
                                    ...
                                    <option <?php if(1== $this->input->post($input) || $data->monday==1){ echo 'selected="selected"';}?>  value="1">Opens</option>
                                    <option <?php if(0== $this->input->post($input) || $data->monday==0){ echo 'selected="selected"';}?>  value="0">Closes</option>
                                </select>
                            </div>  
                        </div>
                        <div class="col-3">
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <div class="controls">
                                    ...
                                    name="<?php echo $input; ?>" 
                                    class="form-control form-control-line" 
                                    value="<?php if(set_value($input) != ''){ echo set_value($input);} else echo "08:30:00";?>" 
                                    >
                                    <div class="text-danger"><?php echo form_error($input);?></div>
                                </div>
                            </div>  
                        ...
                        <div class="col-3">
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <div class="controls">
                                    ...
                                    name="<?php echo $input; ?>" 
                                    class="form-control form-control-line" 
                                    value="<?php if(set_value($input) != ''){ echo set_value($input);} else echo "20:30:00";?>" 
                                    >
                                    <div class="text-danger"><?php echo form_error($input);?></div>
                                </div>
                            </div>  
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <select class="custom-select form-control required" name="<?php echo $input; ?>">
                                    ...
                                    <option <?php if(1== $this->input->post($input) || $data->tuesday==1){ echo 'selected="selected"';}?>  value="1">Opens</option>
                                    <option <?php if(0== $this->input->post($input) || $data->tuesday==0){ echo 'selected="selected"';}?>  value="0">Closes</option>
                                </select>
                            </div>  
                        </div>
                        <div class="col-3">
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <select class="custom-select form-control required" name="<?php echo $input; ?>">
                                    ...
                                    <option <?php if(1== $this->input->post($input) || $data->wednesday==1){ echo 'selected="selected"';}?>  value="1">Opens</option>
                                    <option <?php if(0== $this->input->post($input) || $data->wednesday==0){ echo 'selected="selected"';}?>  value="0">Closes</option>
                                </select>
                            </div>  
                        </div>
                        <div class="col-3">
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <select class="custom-select form-control required" name="<?php echo $input; ?>">
                                    ...
                                    <option <?php if(1== $this->input->post($input) || $data->thursday==1){ echo 'selected="selected"';}?>  value="1">Opens</option>
                                    <option <?php if(0== $this->input->post($input) || $data->thursday==0){ echo 'selected="selected"';}?>  value="0">Closes</option>
                                </select>
                            </div>  
                        </div>
                        <div class="col-3">
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <select class="custom-select form-control required" name="<?php echo $input; ?>">
                                    ...
                                    <option <?php if(1== $this->input->post($input) || $data->friday==1){ echo 'selected="selected"';}?>  value="1">Opens</option>
                                    <option <?php if(0== $this->input->post($input) || $data->friday==0){ echo 'selected="selected"';}?>  value="0">Closes</option>
                                </select>
                            </div>  
                        </div>
                        <div class="col-3">
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <select class="custom-select form-control required" name="<?php echo $input; ?>">
                                    ...
                                    <option <?php if(1== $this->input->post($input) || $data->saturday==1){ echo 'selected="selected"';}?>  value="1">Opens</option>
                                    <option <?php if(0== $this->input->post($input) || $data->saturday==0){ echo 'selected="selected"';}?>  value="0">Closes</option>
                                </select>
                            </div>  
                        </div>
                        <div class="col-3">
                        ...
                        <div class="col-4">
                            ...
                            <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                ...
                                <select class="custom-select form-control required" name="<?php echo $input; ?>">
                                    ...
                                    <option <?php if(1== $this->input->post($input) || $data->sunday==1){ echo 'selected="selected"';}?>  value="1">Opens</option>
                                    <option <?php if(0== $this->input->post($input) || $data->sunday==0){ echo 'selected="selected"';}?>  value="0">Closes</option>
                                </select>
                            </div>  
                        </div>
                        <div class="col-3">
...
<script type="text/javascript">
    var doEdit = false;
    var lat_Edit = '31.5159';
    var lng_Edit = '74.3411';
</script>