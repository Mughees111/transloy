    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="<?php echo $url;?>admin/add-language">
                    <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Add New</button>
                </a>
            </div>
        </div>
    </div>
                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="deleted" href="javascript:void(0);" data-url="<?php echo $url;?>admin/delete-language/<?php echo $language->id;?>"><div class="btn btn-info btn-circle"><i class="mdi mdi-delete"></i></div></a>
