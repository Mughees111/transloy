            ...
            <div class="card">
                ...
                <div class="card-body lang_bodieslisting">
                        ...
                        <select class="custom-select form-control " id="parent" name="<?php echo $input; ?>">
                            ...
                            <optgroup>
                                <?php foreach ($categories->result() as $parent) { ?>
                                    <option <?php if ($parent->id == $data->parent) {
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls ">
                            <div class="switchery-demo m-b-20">
                                <input name="approves_leaves" <?php if ($data->approves_leaves == 1) echo "checked"; ?> value="1" type="checkbox" class="js-switch" data-color="#26c6da" data-secondary-color="#f62d51" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls ">
                            <div class="switchery-demo m-b-20">
                                <input name="can_approve_leaves" <?php if ($data->dep_can_approve_leaves == 1) echo "checked"; ?> value="1" type="checkbox" class="js-switch" data-color="#26c6da" data-secondary-color="#f62d51" />
                            </div>
                        </div>
                    </div>

                    <div class="form-group">
                        <h5>Can this department approve the Allownces?</h5>
                        <div class="controls ">
                            <div class="switchery-demo m-b-20">
                                <input name="can_approve_allowance" <?php if ($data->dep_can_approve_allowance == 1) echo "checked"; ?> value="1" type="checkbox" class="js-switch" data-color="#26c6da" data-secondary-color="#f62d51" />
                            </div>
                        </div>
                    </div>
