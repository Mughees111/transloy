<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Questionnaires Trash Management</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Questionnaires Trash</li>
                </ol>
                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <a title="Restore" href="<?php echo $url;?>admin/restore-questionnaire/<?php echo $questionnaire->id;?>"><div class="btn btn-info btn-circle"><i class="mdi mdi-file-restore"></i></div></a>
                                </td>
                            </tr>
                            <?php }?>
                            </tbody>
