        ...
        <div class="login-box card">
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" id="loginform">
                    <a href="javascript:void(0)" class="text-center db go_center_manager">
                        
                        <img width="40%" src="<?php echo base_url(); ?>resources/uploads/logo/<?php echo $settings->site_logo; ?>" alt="<?php echo settings()->site_title; ?>" /></a>
