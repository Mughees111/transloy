            ...
            <div class="card ">
                ...
                <div class="card-body lang_bodieslisting" id="lang-<?php echo $language->id; ?>listing"
                    ...
                    <div class="form-group <?=(form_error('slug') !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="text" name="slug" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="slug" value="<?php if(set_value('slug') != ''){ echo set_value('slug');}else{ echo $data->slug;}?>" >
