$(function () {
   ...
   $(document).on('click','.push-close',function () {
    ...
    $('.start_date').bootstrapMaterialDatePicker({ weekStart : 0, time: false,maxDate : new Date(new Date().getTime())});
    $('.end_date').bootstrapMaterialDatePicker({ weekStart : 0, time: false,maxDate : new Date(new Date().getTime())});
